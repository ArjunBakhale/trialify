...
import { workingClinicalTrialWorkflow, clinicalTrialWorkflowWithDropoutPrediction } from './workflows/working-clinical-trial-workflow';
...
import { dropoutRiskAgent } from './agents/dropout-risk-agent';
...
export const mastra = new Mastra({
  ...
  agents: { emrAgent, summarizationAgent, trialScoutAgent, eligibilityScreenerAgent, dropoutRiskAgent },
...
// Export the enhanced workflow wrapper for easy access
export { clinicalTrialWorkflowWithDropoutPrediction };
